...
# NEW: Import the meta automator service
from services.meta_automator_service import meta_automator_service
import json
...
def test_meta_integration():
    """
    A safe test endpoint to trigger the Meta Automator Service.
    """
